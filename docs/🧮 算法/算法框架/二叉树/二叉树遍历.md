...
![](https://ricear.com/media/202106/前序遍历（迭代解法）_1623760901.gif)
...
![](https://ricear.com/media/202106/中序遍历（迭代解法）_1623761272.gif)
...
![](https://ricear.com/media/202106/层序遍历（迭代解法：输出二维数组）_1623762105.gif)
...
4. 我们可以实现这样一个递归函数，**通过同步移动两个指针的方法来遍历这棵树**：
   ...
   ![](https://ricear.com/media/202108/2021-08-05_223219.png)
...
2. 我们以 $n = 2$ 为例，画树形结构图，方法是**做减法**。![](https://ricear.com/media/202111/2021-11-13_2156250.32776863153577696.png)
   通过上图，我们可以得出如下结论：
...
1. 这道题目可以采用[深度优先遍历](https://ricear.com/project-21/doc-724/#1-1-%E6%B7%B1%E5%BA%A6%E4%BC%98%E5%85%88%E9%81%8D%E5%8E%86%E7%AE%97%E6%B3%95)的方法来求解：
   1. **序列化**：
      ...
      3. **遇到 `null` 节点也要翻译成特定符号**，**反序列化时才知道这里是 `null`**。![image.png](https://ricear.com/media/202201/2022-01-09_1736130.3886432153851599.png)
   2. **反序列化**：
      1. **反序列化一样**，**也是递归**。
      2. **前序遍历的序列化字符串**，**如下图所示**：![image.png](https://ricear.com/media/202201/2022-01-09_1738130.8641382032786079.png)
      ...
      4. **然后逐个遍历 $arr$ 中的元素**，**构建当前子树的根节点**，**顺着 $arr$**，**构建顺序是根节点**、**左子树**、**右子树**：
         ...
         2. **如果弹出的字符是数字**，**则创建 `root` 节点**，**并递归构建 `root` 的左右子树**，**最后返回 `root`**。![image.png](https://ricear.com/media/202201/2022-01-09_1743510.06430358234861278.png)
...
![](https://ricear.com/media/202106/236-二叉树的最近公共祖先（解法一：前序遍历）_1624369019.gif)
