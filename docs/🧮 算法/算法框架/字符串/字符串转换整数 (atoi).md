...
2. 在计算机科学中，有限状态机被广泛用于**建模应用行为**、**硬件电路系统设计**、**软件工程**、**编译器**、**网络协议**、**计算机与语言的研究**，比如下图非常有名的 TCP 协议状态机：![](https://notebook.ricear.com/media/202107/2021-07-12_2119070.18551046937634952.png)
...
6. 我们可以用**状态表**表示整个过程，如下图所示：![](https://notebook.ricear.com/media/202107/2021-07-12_2131210.030304143730127353.png)
