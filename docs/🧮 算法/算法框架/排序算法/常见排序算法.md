...
![](https://ricear.com/media/202105/2021-05-04_183505.png)
...
![](https://ricear.com/media/202105/2021-05-04_195701.png)
...
3. 快速排序算法的具体过程如下图：
   ...
   ![](https://ricear.com/media/202206/2022-06-27_110211_290113.gif)
...
2. 这个过程也叫做 `partition` 分区，数组的分区很好做，左右两个指针，不断交换就可以了，链表因为只能单向遍历，所以要换一种 `partition` 方法，目的是**使得左边的值都小于 `pivot`**，**右边的值都不小于 `pivot`**，所以**用一个索引记录左边的坐标**，**遍历过程中**，**每次碰到比 `pivot` 小的**，**都要交换一下**，**放到左边**，**遍历完成后**，**再把 `pivot` 放到中间来**，**这样就达成了目的**。
   ...
   ![](https://ricear.com/media/202206/2022-06-27_170430_826067.gif)
...
1. 堆是具有以下性质的完全二叉树：
   ...
   2. **每个节点的值都小于或等于其左右孩子节点的值，称为小顶堆**。
      ![](https://ricear.com/media/202105/2021-05-05_203837.png)
...
2. 随后，**中位数可仅根据 $A、B$ 的堆顶元素计算得到**：
   ...
   ![Picture1.png](https://ricear.com/media/202202/2022-02-09_1419550.3791480604271996.png)
...
![](https://ricear.com/media/202105/2021-05-05_212356.png)

4. **合并相邻有序子序列**的方法：

![](https://ricear.com/media/202105/2021-05-05_212635.png)

![](https://ricear.com/media/202105/2021-05-05_212646.png)
...
### ![](https://ricear.com/media/202105/2021-05-06_191525.png)7.3 算法分析
...
3. **因此**，**考虑在归并排序的合并阶段统计逆序对数量**，**完成归并排序时**，**也随之完成所有逆序对的统计**。
   ...
   ![Picture2.png](https://ricear.com/media/202202/2022-02-10_1954210.9101305560938778.png)
...
![](https://ricear.com/media/202105/2021-05-06_184235.png)
...
![](https://ricear.com/media/202105/2021-05-06_191453.png)
