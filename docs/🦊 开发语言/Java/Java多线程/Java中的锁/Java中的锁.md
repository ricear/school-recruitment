...
![](https://notebook.ricear.com/media/202105//1621914616.920087.png)
...
![](https://notebook.ricear.com/media/202105//1621914616.9237013.png)
...
![](https://notebook.ricear.com/media/202105//1621914616.9263947.png)

3. 公平锁和非公平锁中获取锁的具体实现如下：

![](https://notebook.ricear.com/media/202105//1621914616.9280918.png)
...
![](https://notebook.ricear.com/media/202105//1621914616.9310026.png)
...
![](https://notebook.ricear.com/media/202105//1621914616.9331753.png)
...
![](https://notebook.ricear.com/media/202105//1621914616.9356186.png)
...
![](https://notebook.ricear.com/media/202105//1621914616.9376152.png)
...
![](https://notebook.ricear.com/media/202105//1621914616.9396784.png)
...
![](https://notebook.ricear.com/media/202105//1621914616.9425926.png)
...
![](https://notebook.ricear.com/media/202105//1621914616.9448943.png)
...
4. `AQS` 中有一个 `state` 字段（`int` 类型，32 位），该字段用来描述**有多少线程持有锁**：
   ...
   3. 但是在 `ReentrantReadWriteLock` 中有读、写两把锁，所以需要在一个整形变量 `state` 上分别描述读锁和写锁的状态，于是将 `state` 变量按位切割分成了两个部分，**高 16 位表示读锁状态，低 16 位表示写锁状态**。![](https://notebook.ricear.com/media/202105//1621914616.9469712.png)
5. **获取写锁**的源码及过程如下图：
   
   ![](https://notebook.ricear.com/media/202105//1621914616.9487813.png)
   
   ![](https://notebook.ricear.com/media/202105//1621914616.9527805.png)
...
6. **获取读锁**的源码如下图所示：
   ...
   ![](https://notebook.ricear.com/media/202105//1621914616.955394.png)
...
![](https://notebook.ricear.com/media/202105//1621914616.957492.png)
...
![](https://notebook.ricear.com/media/202105//1621914616.9592867.png)
...
3. 偏向锁的获得和撤销流程如下图所示：![](https://notebook.ricear.com/media/202108/2021-08-01_1646230.6237563968401273.png)
...
4. 如果这个动作**更新成功**了，那么**当前线程就拥有了该对象的锁**，并且**对象 Mark Word 的锁标志位设置为 00**，即表示**此对象处于轻量级锁定状态**，此时线程堆栈与对象头的状态如下图所示：![](https://notebook.ricear.com/media/202108/2021-08-01_1737530.30787306714992335.png)
...
2. 轻量级锁的获得及释放过程如下图所示：![](https://notebook.ricear.com/media/202108/2021-08-01_1750410.7020816132164583.png)
...
![](https://notebook.ricear.com/media/202108/2021-08-02_1016450.034139424210533065.png)

![](https://notebook.ricear.com/media/202108/2021-08-02_1017140.003877683336248383.png)
