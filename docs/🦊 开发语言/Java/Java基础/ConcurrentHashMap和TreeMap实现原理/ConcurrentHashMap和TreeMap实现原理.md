...
1. 从**结构实现**来讲，HashMap 是**数组**+**链表**+**[红黑树](https://ricear.com/project-53/doc-891)**（JDK1.8 增加了红黑树部分）实现的，如下图所示：![](https://notebook.ricear.com/media/202107/2021-07-28_1717200.8508396937310263.png)
